        ...
        return (
            <nav className="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
                <div className="container">
                    <a className="navbar-brand" href="#page-top">Sarah Fredrickson</a>
                    ...
                    <ul className="navbar-nav ms-auto">
                        ...
                        <li className="nav-item mx-0 mx-lg-1"><a className="nav-link py-3 px-0 px-lg-3 rounded" href="#contact-me">Contact Me</a></li>
                    </ul>
                    </div>
                </div>
            </nav>
